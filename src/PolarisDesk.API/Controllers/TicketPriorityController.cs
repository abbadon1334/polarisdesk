...
namespace PolarisDesk.API.Controllers
{
    ...
    public class TicketPriorityController : ControllerBase
    {
        ...
        public IEnumerable<TicketPriority> Get()
        {
            ...
            {
                new TicketPriority() {Name= "Low",Created = DateTime.Now, Value = 100, ID = Guid.NewGuid()},
                new TicketPriority() {Name= "Medium",Created = DateTime.Now, Value = 500, ID = Guid.NewGuid()},
                new TicketPriority() {Name= "High",Created = DateTime.Now, Value = 1000, ID = Guid.NewGuid()},
            };
        }
